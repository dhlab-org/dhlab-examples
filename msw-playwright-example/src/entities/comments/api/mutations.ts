...
export const usePostPostsByPostIdCommentsMutation = (
  options?: Omit<
    UseMutationOptions<CommentDto, DefaultError, TPostPostsByPostIdCommentsVariables>,
...
export const usePutCommentsByIdMutation = (
  options?: Omit<UseMutationOptions<CommentDto, DefaultError, TPutCommentsByIdVariables>, 'mutationFn' | 'mutationKey'>
) => {
  return useMutation({
...
export const useDeleteCommentsByIdMutation = (
  options?: Omit<UseMutationOptions<void, DefaultError, TDeleteCommentsByIdVariables>, 'mutationFn' | 'mutationKey'>
) => {
  return useMutation({
...
type TDeleteCommentsByIdVariables = { id: string; kyInstance?: KyInstance; options?: Options };
