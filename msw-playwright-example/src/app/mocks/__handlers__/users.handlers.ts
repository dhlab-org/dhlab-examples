...
export const usersHandlers = [
  http.get(`${baseURL}/users`, async (info) => {
    ...
    const selectedResult = selectResponseByScenario('get', '/users', resultArray, info, scenarios);
  ...
  http.post(`${baseURL}/users`, async (info) => {
    ...
    const selectedResult = selectResponseByScenario('post', '/users', resultArray, info, scenarios);
  ...
  http.get(`${baseURL}/users/:id`, async (info) => {
    ...
    const selectedResult = selectResponseByScenario('get', '/users/:id', resultArray, info, scenarios);
